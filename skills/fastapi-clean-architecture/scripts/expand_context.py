#!/usr/bin/env python3
"""Write a compact source pack from graph query results."""
...
def build_pack(query: str, limit: int) -> str:
    ...
    lines = [
        f"# FastAPI Clean Architecture Source Pack",
        "",
        f"Query: {query}",
        "",
        "## Nodes",
    ...
    lines.extend(["", "Use this pack as public-safe context. Do not quote full OCR source text from it."])
    return "\n".join(lines) + "\n"
